**Clojure icon** http://exercism.io/img/clojure.png
...
**CoffeeScript icon** http://exercism.io/img/coffeescript.png
...
**Emacs Lisp icon** http://exercism.io/img/elisp.png
...
**Elixir icon** http://exercism.io/img/elixir.png
...
**Erlang icon** http://exercism.io/img/erlang.png
The Erlang logo is in the public domain.


**Lisp Flavoured Erlang icon** http://exercism.io/img/lfe.png
...
**Lisp icon** http://exercism.io/img/lisp.png
The [Lisp logo](http://exercism.io/img/lisp.png) was designed by Xah Lee, and was released into the public domain.


**Lua icon** http://exercism.io/img/lua.png
...
**PHP icon** http://exercism.io/img/php.png
...
**Scheme icon** http://exercism.io/img/scheme.png
...
**Scala icon** http://exercism.io/img/scala.png
...
**Swift icon** http://exercism.io/img/swift.png
